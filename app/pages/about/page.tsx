    ...
    return (
    	<main className="relative">
      		...
      		<div id="section1" className="w-screen relative bg-[#d3d3d3] flex flex-col justify-center items-center box-border pt-[15vh] pb-[10vh]">
        		<div className="sm:w-[75vw] w-[90vw] items-center flex sm:flex-row flex-col justify-evenly text-black py-10 rounded-xl overflow-hidden relative z-0">
					...
					<Image className="z-[2] sm:w-[20%] w-[150px] h-auto mt-5 sm:mt-0" src='/real-logo.png' alt="ex1" width={0} height={0} sizes='100vw'></Image>
				</div>
      		</div>
			...
			<div className="pt-[8vh] pb-[5vh] w-screen text-6xl flex flex-col justify-center items-center bg-[#d3d3d3]">
				...
				<div className="grid lg:grid-cols-4 sm:grid-cols-3 grid-cols-2 grid-flow-row sm:w-[75vw] w-[90vw] box-border relative gap-[4vw]">
					{people.map((person, index) => (	
						<motion.div variants={cardAnimation} initial='initial' whileInView='visible' viewport={{ once: true }} key={index} className="w-full sm:h-[30vh] h-[25vh] bg-white rounded-lg shadow-md flex flex-col items-center gap-5 relative box-border sm:py-6 py-2 overflow-hidden">

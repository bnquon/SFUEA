  ...
  return (
    <div className='pt-[20vh] relative bg-[#d3d3d3]'>
        <div className="w-full lg:h-[50vh] bg-black relative sm:pl-[12.5vw] pl-[5vw]">
            ...
            <div className="text-white lg:w-[37.5vw] sm:w-[75vw] w-[90vw] relative bg-red-500 rounded-3xl -translate-y-1/3 flex flex-col justify-between sm:p-10 py-6 px-3 box-border">
                <div>
            ...
            <div className='relative sm:w-[75vw] w-[90vw] flex flex-col justify-center items-center lg:justify-start lg:items-start mt-[-20px] text-white'>
                ...
                <div className='lg:flex lg:flex-col lg:justify-center lg:items-center lg:gap-4 lg:mb-5 mt-4 sm:mt-4 lg:absolute w-[45%] h-full right-0 top-0 lg:translate-y-[-75%] xl:translate-y-[-50%] flex flex-col items-center justify-center gap-10 xl:gap-14'>
                    ...
                    <p className='text-xl xl:text-2xl text-center text-white'>Contact us: EMAIL@EMAIL.COM</p>
                </div>

                <div className='flex flex-col justify-center items-center lg:absolute lg:bottom-0 lg:left-1/2 lg:translate-y-[calc(50%+20px)] lg:-translate-x-1/2 sm:mt-0'>
